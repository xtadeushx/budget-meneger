...
const CategoryModalEdit: React.FC<ICategoryModalProps> = ({ type, id, setVisibleModal }) => {
  const [title, setTitle] = useState('');

  const queryClient = useQueryClient();

  const mutation = useMutation(categoryService.updateCategory, {
    onSuccess: () => {
